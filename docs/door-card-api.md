...
- Preview zoom: `+/−` and Reset 100% on the remote stage CSS-scale the noVNC canvas (pinch does not zoom the remote page). Does not change Solari DPI. Typing field stays.
