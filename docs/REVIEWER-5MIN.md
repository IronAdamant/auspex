...
| --- | --- | --- |
| 0:00–1:00 | Open [Pages](https://ironadamant.com/auspex/). Read the triad above the player: **`ok` ≠ `claimOk` ≠ `claimOkProfile`**. In-repo login doors (handoff only, not a full SaaS walk): [phone](../examples/auspex-ts/demo/door-phone.gif) and [desktop](../examples/auspex-ts/demo/door-desktop.gif), also at the top of the [root README](../README.md#login-doors-phone-and-desktop). | Header copy, stills, door GIFs |
