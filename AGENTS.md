...
| `next` | string | Structured agent guidance for `loggedOut`, `needsHuman`, `--verify-with-profile` reuse-gate (`claimOkProfile`), Save-is-not-fold, or a profile/host mismatch (`profileHostMatch` false) |
