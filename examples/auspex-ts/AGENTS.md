...
- **Preview zoom:** `phone.html` (and `desktop.html`) has **+/−** and **Reset 100%** on the remote stage. That CSS-scales the noVNC canvas for the human (pinch does not zoom the remote page). It does not change Solari DPI. The typing field stays.
