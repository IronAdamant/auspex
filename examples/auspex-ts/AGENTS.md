...
# human: phone → handoff.mobileUrl (Auspex phone page, real text field) in the phone's own Safari or Chrome; tap Save on that page. Do not open Solari (GET editor HTTP 401). Then await-login --save-editor. Do not intern-ping.
