...
# human: phone → handoff.mobileUrl (Auspex phone page, real text field) in the phone's own Safari or Chrome; computer → handoff.desktopUrl. Microsoft consent in the handoff, then Save. Do not intern-ping.
