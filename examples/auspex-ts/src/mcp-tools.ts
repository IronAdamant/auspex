...
const FINALIZE_LOGIN_DESCRIPTION =
  "Post-login one-shot: after await-login (or a weak-seed warn), run SSO + save-profile in one step to capture sessionStorage. Defaults to ConsistencyHub URL and expect. Same as CLI finalize-login / check --profile --sso --save-profile. Use when console Save alone is insufficient."
