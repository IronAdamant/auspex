...
export const AWAIT_LOGIN_DESCRIPTION =
  ...
  "If editorSave is 200 and editorFold is no-cdp, or editorSave fails, finalize-login NOW even when the VNC JWT is past. " +
  "Leftover sessionStorage is not a fresh capture. " +
  "Do not remint for stream-expired when cookies exist. Do not verify-with-profile on that fold. " +
